...
this.submitted = false;
      ...
      handleInputChange = event => {
         ...
         let{name, value} = event.tagert;
         if(name === "full_name"){
            if(value.lenght < 10){
               this.setState({errFullName: "full name length < 10"})
            }else if(value.length >10){
               this.setState ({errFullName: ""})
            }

            else if(name ==="phone"){
               if(value.lenght < 6 || value.lenght >10){
                  this.setState({errPhone: "Phone number error"})
               }else if (value.lenght > 6 && value.lenght == 10){
            ...
            <div className="col-md-4 col-md-offset-4">
               <form className="registrationForm">
                  ...
                  <div className={validation.email.isInvalid && 'has-error'}>
                     ...
                     <span className="help-block">{this.state.errFullName}</span>
</div>
<div className={validation.email.isInvalid && 'has-error'}>
